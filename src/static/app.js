document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      const activityDifficulty = (
        typeof details.difficulty === "string" ? details.difficulty : ""
      ).toLowerCase();
  ...
  function renderActivityCard(name, details) {
    ...
    const difficultyLabel = activityDifficulty
      ? activityDifficulty.charAt(0).toUpperCase() + activityDifficulty.slice(1)
      : "";
    ...
    activityCard.innerHTML = `
      ...
      ${difficultyLabel ? `<p><strong>Difficulty:</strong> ${difficultyLabel}</p>` : ""}
      ${capacityIndicator}
